package com.chat.xteam.metalk.ui.activity;
...
import com.chat.xteam.metalk.adapter.ListMessageAdapter;
import com.chat.xteam.metalk.data.SharedPreferenceHelper;
import com.chat.xteam.metalk.data.StaticConfig;
import com.chat.xteam.metalk.model.Consersation;
import com.chat.xteam.metalk.model.Message;
...
//    private EditText editWriteMessage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtEmoji=findViewById(R.id.editWriteMessage);
        imgButton=findViewById(R.id.imgEmoj);
        emojIconActions=new EmojIconActions(getApplication(),layout,edtEmoji,imgButton);
...
//            String content = editWriteMessage.getText().toString().trim();
            String content = edtEmoji.getText().toString().trim();
            if (content.length() > 0) {
                edtEmoji.setText("");
