...
import com.chat.xteam.ichat.data.StaticConfig;
import com.chat.xteam.ichat.service.ServiceUtils;
import com.chat.xteam.ichat.ui.FriendsFragment;
import com.chat.xteam.ichat.ui.GroupFragment;
import com.chat.xteam.ichat.ui.LoginActivity;
import com.chat.xteam.ichat.ui.NewsFragment;
import com.chat.xteam.ichat.ui.UserProfileFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static String STR_NEWS_FRAGMENT="NEWS";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(toolbar != null) {
            ...
            getSupportActionBar().setTitle("MeTalk");
        }
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new NewsFragment(),STR_NEWS_FRAGMENT);
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            Toast.makeText(this, "MeTalk version 1.0", Toast.LENGTH_LONG).show();
            return true;
        }
